...
/*<----------------Passagem-------------->*/
Delimiter $$
create procedure SP_Cadastrar_Passagem
(in cli int, in viagem int, in formPag int, in cpf char(14), in desconto decimal(3,2), in valor decimal(3,2), in dataCompra datetime)
begin 
	 insert into Passagem(id_Cliente, id_Viagem, id_FormPag, cpf_Cliente, desconto_Passagem, valor_Passagem, data_Compra)
     values(cli, viagem, formPag, cpf, desconto, valor, dataCompra);
end $$
Delimiter ;
